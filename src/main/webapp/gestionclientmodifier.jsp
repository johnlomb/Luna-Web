...
<header> <img id="gauche" src="img/logo-as.png" />
	...
	<s:form action="modifClient" method="POST">
		...
		<s:textfield type="number" name="codepostal" id="codepostal" label="Code Postal"></s:textfield>
		...
		<s:checkbox name="cartefidelite" fieldValue="true" label="Carte de Fidélité" />
