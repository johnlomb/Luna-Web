...
<body>
	...
	<div id="content">
		<s:form action="addArticle" validate="true">
			...
			<s:textfield name="codecategorie" id="codecategorie"
				label="Catégorie"></s:textfield>
			<s:textfield name="designation" id="designation" label="Désignation"></s:textfield>
			<s:textfield type="number" name="prixunitaire" id="prixunitaire"
				label="Prix Unitaire"></s:textfield>
